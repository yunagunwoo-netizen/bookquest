...
[★ 다양성 강제 (매우 중요)]
- 5라운드의 **책은 가능한 한 모두 다르게** 골라. 같은 책 두 번 이상 출제 금지 (책 풀이 4권 이하면 어쩔 수 없이 중복 가능).
- 같은 책에서 출제하더라도 **다른 키포인트·다른 시각·다른 영역**으로. 같은 사실을 다시 묻지 마.
- 직전 배틀과 비슷한 질문을 의도적으로 피해. 아래 [다양성 시드]가 매 배틀마다 다르니, 그 시드를 보고 새로운 질문 5개를 창의적으로 생성해.
- 책의 keyPoints 중 마지막에 나오는 것 / 자주 안 다뤄지는 디테일도 적극 활용해.
